...
type Submission = { id: number; assignment_id: number; student_id: number; student_name: string | null; version: number; original_filename: string; note: string; created_at: string; graded: boolean };
