...
export function AdminClassPage() {
  ...
  async function remove() {
    ...
    try { await removeStudent(classId, removing.id); setRemoving(null); await load(); }
