...
type Submission = { id: number; assignment_id: number; student_id: number; version: number; original_filename: string; created_at: string; graded: boolean };
